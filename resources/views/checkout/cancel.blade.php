<x-base-layout title="Payment cancle">
    <div class="grid min-h-full place-items-center bg-white px-6 py-24 sm:py-32 lg:px-8">
        <div class="text-center">
            ...
            <h1 class="mt-4 text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl">Payment Canceled!</h1>
            <p class="mt-6 text-base leading-7 text-gray-600">We're sorry to see that your payment was not completed.</p>
            <div class="mt-10 flex items-center justify-center gap-x-6">
                ...
                <a href="{{ $checkout_url }}" class="text-sm font-semibold text-gray-900">Retry your payment</a>
            </div>
        </div>
    </div>
</x-base-layout>