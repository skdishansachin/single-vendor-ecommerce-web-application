<x-base-layout title="Checkout Error">
    <div class="grid min-h-full place-items-center bg-white px-6 py-24 sm:py-32 lg:px-8">
        <div class="text-center">
            ...
            <h1 class="mt-4 text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl">We got stuck!</h1>
            <p class="mt-6 text-base leading-7 text-gray-600">Don't panic check you orders here.</p>
            <div class="mt-10 flex items-center justify-center gap-x-6">
                ...
                <!-- TODO - Coustomer feedback and helpdesk -->
                <a href="#" class="text-sm font-semibold text-gray-900">Report Us</a>
            </div>
        </div>
    </div>
</x-base-layout>