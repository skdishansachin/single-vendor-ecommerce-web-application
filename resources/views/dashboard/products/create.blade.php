<x-app-layout title="Create product">
    <x-slot name="header">
        ...
        <div>
            <x-primary-button form="product_create_form">create</x-primary-button>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form action="{{ route('dashboard.products.store') }}" method="POST" enctype="multipart/form-data" id="product_create_form">
                @csrf
                            ...
                            <div class="p-6 text-gray-900">
                                ...
                                <div class="mt-4 flex items-start gap-5">
                                    ...
                                    <div class="w-full">
                                        ...
                                        <x-text-input id="available" name="available" type="number" class="mt-1 block w-full" :value="old('available')" required />
                                ...
                                <div>
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <select name="collection" id="collection" class="mt-2 block w-full rounded-md border-0 py-1.5 text-gray-900 ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                            ...
                                            <option value="{{ $collection->id }}" @selected(old('collection')==$collection)>{{ $collection->name }}</option>
                                            @endforeach
                                        </select>
                                        @else
                                        <p class="text-sm text-gray-500 leading-6">No collections available now. Create a <a href="{{ route('dashboard.collections.create') }}" class="text-indigo-500 underline">new one</a> or continue without assigning.</p>
                                        @endif
                                    </div>
